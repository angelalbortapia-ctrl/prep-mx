/**
 * Genera src/data/ipn-temario-historia.ts — Examen IPN.
 */
...
const outPath = join(__dirname, '../src/data/ipn-temario-historia.ts');
    ...
    children: [
      {
        ...
        descripcion:
          'Relación exacta de documentos armados con sus objetivos y proclamadores: Plan de San Luis (Madero, 1910): desconoce a Porfirio Díaz e inicia la Revolución. Plan de Ayala (Zapata, 1911): desconoce a Madero y exige restitución de tierras agrarias. Plan de Guadalupe (Carranza, 1913): desconoce al usurpador Victoriano Huerta y organiza el Ejército Constitucionalista. Plan de Agua Prieta (Plutarco Elías Calles/Álvaro Obregón, 1920): desconoce a Carranza.',
        orden: 1,
      },
      {
        id: 'ipn-hist-7-1-2',
...
export const IPN_HISTORIA_TOPICS: UnamTemarioTopic[] = ${JSON.stringify(normalized, null, 2)} as UnamTemarioTopic[];
`,
  'utf8'
);
