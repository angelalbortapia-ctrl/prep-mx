...
export const projectPhases: ProjectPhase[] = [
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        action: 'Verifica con `npm run check:supabase`. Si falta migración 002, ejecútala en SQL Editor.',
      },
      {
        id: '1-6',
        ...
        action: 'Crea app en dashboard.clerk.com → copia las keys a `.env.local` → prueba registro → onboarding → dashboard.',
      },
      {
        id: '1-7',
        ...
        action: '229 preguntas cargadas. Importa más con `npm run import:questions` si hace falta.',
      },
      {
        id: '1-8',
    ...
    tasks: [
      {
        ...
        action: '✅ `/api/exams/submit` guarda en Supabase. Falta: Inngest + job de diagnóstico IA.',
      },
      {
        id: '2-2',
      ...
      },
      {
        ...
        action: 'Tras cada respuesta en `/api/exams/submit`, se actualiza `user_progress` con SM-2.',
      },
      {
        id: '2-3',
