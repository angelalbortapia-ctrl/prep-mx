...
import { WeaknessEmptyState } from '@/components/dashboard/WeaknessEmptyState';
...
interface WeaknessRadarProps {
  /** Si se pasa un arreglo vacío, muestra el estado vacío. Si se omite, usa datos demo. */
  items?: WeaknessItem[];
}

export function WeaknessRadar({ items }: WeaknessRadarProps) {
  const weaknesses = items ?? demoWeaknesses;
